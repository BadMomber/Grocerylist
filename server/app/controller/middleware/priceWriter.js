    ...
    try {
      ...
      let watchJob = setInterval (async function () {
        ...
        if (jobIsDone === true) {
          ...
          let priceAsNumber = parseFloat(newProduct.price,10);
          let priceSummedAsNumber = newProduct.amount * priceAsNumber;
          
          let priceSummedAsString = priceSummedAsNumber.toString();
          
          newProduct.priceSummed = priceSummedAsString;
